        ...
        <div class="row clearfix">
            <div class="col-md-10 column">
                <div class="form-group has-success col-xs-6 col-sm-3" style="width: 130px">
                    <label for="" class="sr-only control-label">姓名:</label>
                ...
                <table class="table table-striped table-bordered table-hover text-center">
                    ...
                    <c:forEach items="${page.list}" var="user">
                        <tr class="tr">
                            ...
                            <td>${user.email}</td>
                            <td>
                                <button type="button" class="btn btn-default btn-warning btn-sm" onclick="location.href = ''">
                                    添加
                                </button>
                                <button type="button" class="btn btn-default btn-danger btn-sm" onclick="location.href = ''">
                                    删除
                                </button>
                            </td>
                        </tr>
